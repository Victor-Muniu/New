...
class RoomUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => CheckInUpdateManyWithoutRoomsInput,
  })
  @ValidateNested()
  @Type(() => CheckInUpdateManyWithoutRoomsInput)
  @IsOptional()
  @Field(() => CheckInUpdateManyWithoutRoomsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => CheckOutUpdateManyWithoutRoomsInput,
  })
  @ValidateNested()
  @Type(() => CheckOutUpdateManyWithoutRoomsInput)
  @IsOptional()
  @Field(() => CheckOutUpdateManyWithoutRoomsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => GuestServiceUpdateManyWithoutRoomsInput,
  })
  @ValidateNested()
  @Type(() => GuestServiceUpdateManyWithoutRoomsInput)
  @IsOptional()
  @Field(() => GuestServiceUpdateManyWithoutRoomsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => RoomStatusUpdateManyWithoutRoomsInput,
  })
  @ValidateNested()
  @Type(() => RoomStatusUpdateManyWithoutRoomsInput)
  @IsOptional()
  @Field(() => RoomStatusUpdateManyWithoutRoomsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => MaintenanceRequestUpdateManyWithoutRoomsInput,
  })
  @ValidateNested()
  @Type(() => MaintenanceRequestUpdateManyWithoutRoomsInput)
  @IsOptional()
  @Field(() => MaintenanceRequestUpdateManyWithoutRoomsInput, {
    nullable: true,
  })
